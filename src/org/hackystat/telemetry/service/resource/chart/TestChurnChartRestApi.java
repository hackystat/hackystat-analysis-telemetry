 ...
 */
public class TestChurnChartRestApi extends TelemetryTestHelper {
  ...
  @Test public void testChart() throws Exception {
    ...
    assertEquals("Checking point 1 is 60", "60", points.get(0).getValue());
    assertEquals("Checking point 2 is 90", "90", points.get(1).getValue());
    assertEquals("Checking point 3 is 90", "120", points.get(2).getValue());
