...
/**
 * A reference to y-axis definition by its name. This is used by 
...
public class YAxisReference {
  ...
  /** The name of y-axis being referenced. */
  private String name;
   ...
   */
  public YAxisReference(String name, Expression[] parameters) {
    this.name = name;
