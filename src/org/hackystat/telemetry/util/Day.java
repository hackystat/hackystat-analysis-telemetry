package org.hackystat.telemetry.util;
...
public class Day implements TimePeriod {
  ...
  private static SimpleDateFormat toStringFormat = new SimpleDateFormat("dd-MMM-yyyy");
  ...
  private static SimpleDateFormat monthStringFormat = new SimpleDateFormat("MM");
  /** The formats for the getting the day, month, and year fields as strings. */
  private static SimpleDateFormat mediumMonthStringFormat = new SimpleDateFormat("MMM"); 
  /** Year string formatter. */
  private static SimpleDateFormat yearStringFormat = new SimpleDateFormat("yyyy");
  /** Day string formatter. */
  private static SimpleDateFormat dayStringFormat = new SimpleDateFormat("dd");
  ...
  /**
   * Returns a Date object that corresponds to the current day.
