 ...
 * Package private because only User should be interacting with this class.
 *  
 * @author    Philip M. Johnson
 * @version   $Id: UserKeyGenerator.java,v 1.1.1.1 2005/10/20 23:56:44 johnson Exp $
 */
  ...
  /**
   ...
   public static String make() {
     ...
     while (!isUniqueKey) {
       ...
       isUniqueKey = !UserManager.getInstance().isUserKey(userKey.toString());
     }
